...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      desc: `Smart Agro Hub is a web-based agriculture-focused platform designed to 
address these challenges by integrating an online marketplace with an 
agricultural information system. The platform enables farmers and customers 
to buy and sell agricultural products while also accessing farming tips, guides 
and essential information. `,
      img: "https://i.ibb.co.com/v4q7Qtp1/Screenshot-2026-04-05-205854.png",
      tech: ["React", "Tailwind CSS", "DaisyUI","MongoDB","Node.js","Express"],
  ...
  return (
    <section
      id="projects"
      className="pt-24 bg-gradient-to-r from-black via-gray-900 to-black text-white"
    >
      {/* Heading */}
